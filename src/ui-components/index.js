...
export { default as AddFrog } from "./AddFrog";
...
export { default as FrogCard } from "./FrogCard";
export { default as FrogCreateForm } from "./FrogCreateForm";
export { default as FrogNavBarHeader } from "./FrogNavBarHeader";
export { default as FrogNavBarHeader2 } from "./FrogNavBarHeader2";
export { default as FrogNavBarHeader3 } from "./FrogNavBarHeader3";
export { default as FrogUpdateForm } from "./FrogUpdateForm";
...
export { default as NewFrogsCollection } from "./NewFrogsCollection";
